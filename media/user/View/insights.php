                    ...
                    <div class="post-comt-box">
                        <form method="post">
                            <div class="img-cmt">
                                ...
                                ?>
                                <input class="input" id="binhluan_<?= $item['posts_id'] ?>" type="text" name="contentcmt" placeholder="Bình luận">
                                <a class="inputs submit-cmt" type="submit" name="submit-cmt" data-post="<?= $item['posts_id'] ?>" placeholder="Bình luận"> gửi</a>
                            </div>
                        </form>
                    </div>
                </div>
